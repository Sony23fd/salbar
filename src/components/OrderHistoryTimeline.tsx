  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between pb-2 border-b border-slate-200">
        ...
        <span className={`px-2 py-0.5 text-[11px] font-extrabold rounded-md border ${statusColors[currentStatus]}`}>
          Одоогийн төлөв: {statusTranslations[currentStatus]}
        </span>
      </div>
              ...
              <div className="bg-white border border-slate-200 rounded-xl p-3.5 space-y-2 hover:border-slate-300 transition-colors shadow-xs">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <span className={`px-2 py-0.5 text-[10px] font-bold rounded border ${statusColors[log.status]}`}>
