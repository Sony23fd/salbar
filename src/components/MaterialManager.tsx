              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    step="any"
                    value={minStockLevel}
                    onChange={(e) => setMinStockLevel(e.target.value === '' ? '' : parseFloat(e.target.value))}
                    placeholder="10"
                    className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs font-mono"
                  />
                </div>
            ...
            <form onSubmit={handleReplenishMaterial} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  step="any"
                  value={replenishQty}
                  onChange={(e) => setReplenishQty(e.target.value === '' ? '' : parseFloat(e.target.value))}
              ...
              {replenishTarget.unit?.toLowerCase() === 'кг' && (
                <div className="animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <input
                    ...
                    onChange={(e) => setReplenishSecondaryQty(e.target.value === '' ? '' : parseFloat(e.target.value))}
